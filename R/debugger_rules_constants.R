...
RULE_CONFIG_FILE = function(){
  system.file(file.path("rule_config_jsons", "ruleConfigs.json"), package="R6sagemaker.debugger")
}
COLLECTION_CONFIG_FILE = function(x){
  system.file(file.path("rule_config_jsons", "collections.json"), package="R6sagemaker.debugger")
}
